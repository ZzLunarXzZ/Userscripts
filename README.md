...
1. Install a userscript manager:
   ...
   - Firefox → [Tampermonkey](https://www.tampermonkey.net/) or Violentmonkey
2. Enable **developer mode** in the Tampermonkey extension settings (important for GitHub raw installs).
3. Go to any `.user.js` file in this repo, click **Raw**, and Tampermonkey should prompt you to install.
...
### Lightning (Yellow)
![Lightning Console](<img width="1919" height="872" alt="Screenshot 2026-02-22 134902" src="https://github.com/user-attachments/assets/39d07e2a-c349-49db-bb5a-f45f721a5a73" />)
![Lightning Title Screen](<img width="1919" height="873" alt="Screenshot 2026-02-22 134838" src="https://github.com/user-attachments/assets/c460db81-4bc5-4c59-8332-396bc856e313" />
)
